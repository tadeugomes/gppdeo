...
description: |
  Novamente o debate sobre a privatização dos Correios
author:
  - name: Tadeu Gomes Teixeira
    url: 
date: 07-07-2021
preview: http://books.scielo.org/id/28w3s/cover/cover.jpeg
output:
...
Novamente a pauta de privatização dos Correios toma fôlego e, com ela, os debates nas redes sociais e nos veículos de comunicação.

Estudei durante o doutorado o setor postal brasileiro e os Correios, o que resultou em artigos e um livro que pode ser consultado [aqui gratuitamente graças ao Scielo Book](http://books.scielo.org/id/28w3s).

![](livro.png){width="3.3cm" height="4.6cm"}

Tenho conversado conversado com jornalistas sobre a eterna crise na empresa e compartilho aqui as questões e respectivas respostas de uma dessas entrevistas. Ao final indico algumas reportagens em que contribuí e que sistematizam as discussões.

Antes disso, contudo, deixo aqui um debate que fizemos sobre a privatização dos Correios coordenador pelo PET de Economia da Federal de Uberlândia. Mais que ser a favor e contra a priori, a ideia é matizar o debate, entender os rumos do setor postal e compreender como as mudanças no marco regulatório do setor podem repercutir em várias frentes. Recomendo o debate (link na imagem).

[![](cartaz.png){width="4.6cm"}](https://www.youtube.com/watch?v=emBr4FuF7RA)
...
Um gráfico com boa visualização dos resultados financeiros recentes da empresa pode ser acessado [aqui](https://valor.globo.com/empresas/noticia/2020/11/25/correios-devem-ter-lucro-bilionario-no-ano.ghtml).
